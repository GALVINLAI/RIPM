...
% To specify options whilst not specifying an initial guess, give x0 
% as [] (the empty matrix).
...
% cost. 
%
% The struct-array info contains information about the iterations:
...
%       passed to the line search too, so you can pass it parameters. 
...
%       They will be returned in the info struct. 
